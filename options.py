...
def parse_args_train():
    ...
    parser.add_argument('--modellr', help='initial learning rate of network', type=float, default=0.1)
    parser.add_argument('--centerlr', help='initial learning rate of centers', type=float, default=0.01)
    ...
    parser.add_argument('--la', default=20, type=float, help='lambda')
